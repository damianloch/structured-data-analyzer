...
* @see https://v0.dev/t/dLCDOljZK1F
...
export function Component() {
  ...
  const handleFileUpload = (e) => {
    ...
    if (uploadedFile && (uploadedFile.type === "application/vnd.ms-excel" || uploadedFile.type === "text/csv")) {
  ...
  return (
    <div className="flex h-screen w-full flex-col items-center justify-center bg-background">
      <div className="w-full max-w-3xl rounded-2xl bg-card p-6 shadow-lg">
        ...
        <form onSubmit={handleQuestionSubmit} className="mb-6 flex items-center gap-4">
          <Input
            type="text"
          ...
          <Button type="submit" disabled={loading}>
            {loading ? <LoaderPinwheelIcon className="h-5 w-5 animate-spin" /> : "Submit"}
          </Button>
        </form>
